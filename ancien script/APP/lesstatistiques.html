...
<html>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link media="screen" rel="stylesheet" href="lesstatistiques.css">
	...
	<div class="bgimg">
			<div class="header">
				<div class="elementsduheader">
					...
					<div class="box_aa">
						<h2 class="aa"> AFFICHAGE DES STATISTIQUES POUR LES TESTS. </h2>
					</div>    



				<div class="boxe8"> <p> Affichage des statistiques</p></div>        
