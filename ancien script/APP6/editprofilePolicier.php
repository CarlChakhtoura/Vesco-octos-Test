	...
	<body>
		...
		?>
			...
			<div class="contenusite">
				...
				<div class="card">
					...
					<form method="POST" action="siteProfileModificationPolicier.php"><!--A FAIRE-->
						<label>Nom</label><input type="text" name="nom" value="<?php echo decryptageDuNom($_SESSION['lastNameCop']); ?>"/><br>
						<label>Prenom</label><input type="text" name="prenom" value="<?php echo decryptageDuNom($_SESSION['firstNameCop']); ?>" /><br>
						<label>Mot de Passe</label><input type="password" name="motDePasse1" value="<?php echo $_SESSION['password']; ?>" /><br>
						<label>Confirmation du mot de passe</label><input type="password" name="motDePasse2" value="<?php echo $_SESSION['password']; ?>" /><br>
						<label>Email</label><input type="text" name="email" value="<?php echo $_SESSION['emailCop']; ?>"/><br>
						<label>Telephone </label><input type="text" name="telephone" value="<?php echo $_SESSION['telephoneCop']; ?>"/><br>
			...
			<div id="side-menu" class="side-nav">
			    ...
			    <a href="editprofilePolicier.php?cert=5">Mon Profil</a>
			  </div>
