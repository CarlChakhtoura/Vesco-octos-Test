		...
		?>
			...
			<div class="contenusite">
				...
				<div class="card">
			        ...
			        <div class="card-body">
			            <p class="full-name"><?php echo decryptageDuNom($_SESSION['lastNameCop']);
													echo " "; 
													echo decryptageDuNom($_SESSION['firstNameCop']); ?>
											</p>
			        ...
			        <div class="card-footer">
			            <div class="col vr">
			                <a href="editprofilePolicier?cert=5.php">Edition profil</a>
			            </div>
			            <div class="col">
			               <a href="controlePolicier?cert=5.php">Retour à l'accueil</a>
			            </div>
			        </div>
			    </div>
