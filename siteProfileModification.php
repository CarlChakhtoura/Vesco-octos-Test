<?php
	...
	$_SESSION["Lastname"]=cryptageDuNom($_POST['nom']);
	$_SESSION["Firstname"]=cryptageDuNom($_POST['prenom']);
	$_SESSION["Email"]=$_POST['email'];
	$_SESSION["motDePasse"]=$_POST['motDePasse1'];
	$_SESSION["sexe"]=$_POST['sexe'];
	$_SESSION["nationalite"]=$_POST['nationalite'];
	$_SESSION["code_postal"]=$_POST['codePostal'];
	$_SESSION["adresse"]=cryptageDeLAdresse($_POST['adresse']);
